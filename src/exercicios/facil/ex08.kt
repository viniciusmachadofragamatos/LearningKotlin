...
fun main() {
    _root_ide_package_.exercicios.facil.saudar("joão")
    _root_ide_package_.exercicios.facil.maiorDeTres(2, 1, 3)
    println(_root_ide_package_.exercicios.facil.somar(1, 2))
}